...
export default class JhiUserManagementComponent extends Vue {
  ...
  public deleteUser(): void {
    this.userManagementService()
      ...
      .then(res => {
        const message = this.$t(res.headers['x-jhipstersampleapplication2app-alert'], {
          param: decodeURIComponent(res.headers['x-jhipstersampleapplication2app-params'].replace(/\+/g, ' ')),
        });
